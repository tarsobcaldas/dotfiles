...
#  endif
...

    {
        ...
        cv = newXS_deffile("Cpanel::JSON::XS::dupkeys_as_arrayref", XS_Cpanel__JSON__XS_ascii);
        XSANY.any_i32 = F_DUPKEYS_AS_AREF;
        ...
        XSANY.any_i32 = F_CONV_BLESSED;
        cv = newXS_deffile("Cpanel::JSON::XS::get_dupkeys_as_arrayref", XS_Cpanel__JSON__XS_get_ascii);
        XSANY.any_i32 = F_DUPKEYS_AS_AREF;
